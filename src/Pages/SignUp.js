...
const SignUp = () => {
   ...
   const {userName , email , password} =  formValue;
     ...
     const showPassword = (e) =>{
        ...
        if(passwordInp.style.display && e.target.isChecked ){
            passwordInp.setAttribute("type","none");
        }else if(!e.target.isChecked){
            passwordInp.setAttribute("type","block");
        }
