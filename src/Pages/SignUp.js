  ...
  return (
    ...
    <div className="h-3/4 md:h-full">
      <div
        ...
        <div className="md:mb-0 w-11/12 md:w-8/12 lg:w-5/12 xl:w-5/12">
          <form action="/" className="bg-white rounded-3xl  p-4">
            <div
              className="flex flex-row items-center justify-center lg:justify-center">
              <p className="mb-0 mr-4 text-lg text-center text-gray-300">Sign in with</p>
              <button
                type="button"
                data-te-ripple-init
